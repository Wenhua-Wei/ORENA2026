...
class InternVLInferenceEngine:
    ...
    def load(self) -> None:
        ...
        # print(
        #     f"Original InternVL system message: "
    ...
    def _generate_without_system(
        ...
        *,
        ...
        """Generate with internvl2_5 user/assistant serialization and no system turn."""
        ...
        if img_context_token_id is None:
            raise RuntimeError("Tokenizer does not contain <IMG_CONTEXT>.")

        self.model.img_context_token_id = int(img_context_token_id)

        # Intentionally NO system turn here.
        query = (
            "<|im_start|>user\n"
            + question
            + "<|im_end|>\n"
        ...
        if "<image>" in query:
            raise RuntimeError("Unexpanded <image> placeholder remains.")
